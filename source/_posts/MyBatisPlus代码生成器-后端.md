...
```java
package com.demo.dora.mybatisplus.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static StrategyConfig initStrategyConfig(String[] tableNames) {
        ...
        strategyConfig.setEntityTableFieldAnnotationEnable(true); // 生成mysql数据库表对应字段的注解
        //当表名中带*号时可以启用通配符模式
    ...
    private static InjectionConfig initInjectionConfig(String projectPath, String moduleName) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mybatisplustor/" + moduleName
...
另外需要配置连接数据库文件generator.properties：

```java
dataSource.url=jdbc:mysql://XXX:3306/数据库?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai
dataSource.driverName=com.mysql.cj.jdbc.Driver
dataSource.username=XX
dataSource.password=XX
package.base=com.demo.dora.mybatisplus.modules
```
...
![](https://img.wuzhouboy.top/blog/2194790a721f/14b2a872-b756-41a8-843f-2aa714d6dcbf.jpeg)
