...
- [网络损伤模拟仪](https://github.com/jumper2014/awesome-test-tool/blob/master): 硬件网络损伤仿真仪器，用于模拟广域网的各种弱网条件，例如丢包，延迟，低带宽等。
...
- [reportportal](https://github.com/jumper2014/awesome-test-tool/blob/master): AI-powered Test Automation Dashboard
